import React, { useRef } from "react"; //useState hook to manage the state of the modal
        ...
        <Modal.Body>
          <form onSubmit={handleOnSubmit}>
            ...
            <div className="button-submit">
              ...
              <button type="button" className="cancel-button btn btn-secondary" onClick={handleClose}>Cancel</button>
            </div>
          </form>
        </Modal.Body>
      </Modal>
